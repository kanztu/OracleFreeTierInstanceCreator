...
func (o *OCI) CreateInstance() (string, error) {
	request := core.LaunchInstanceRequest{
		LaunchInstanceDetails: core.LaunchInstanceDetails{
			...
			SourceDetails:                  &core.InstanceSourceViaImageDetails{ImageId: common.String(o.imageID)},
			SubnetId:                       common.String(o.subnetID),
			Metadata:                       map[string]string{"ssh_authorized_keys": o.sshKeys},
			CreateVnicDetails:              &core.CreateVnicDetails{SubnetId: &o.subnetID, AssignPublicIp: common.Bool(true), AssignPrivateDnsRecord: common.Bool(true)},
